...
contract Instrument {
     ...
     */
    event EventTimeScheduled(uint256 indexed issuanceId, uint256 timestamp, string eventName, string eventPayload);
     ...
     * @param eventPayload The payload the custom event
     */
    event EventBlockScheduled(uint256 indexed issuanceId, uint256 blockNumber, string eventName, string eventPayload);
