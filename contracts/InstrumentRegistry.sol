...
contract InstrumentRegistry is WhitelistAdminRole {
    ...
    function create(address fspAddress, address instrumentAddress, uint256 expiration) public onlyWhitelistAdmin {
        ...
        _storage.setString(getInstrumentStatusKey(instrumentAddress), string(instrumentStatus.encode()));
        ...
        _storage.setString(getFSPStatusKey(fspAddress), string(fspStatus.encode()));
    }
